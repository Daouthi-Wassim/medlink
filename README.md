...
- TypeScript
- Node.js
- Système de chiffrement personnalisé
...
```bash
git clone https://github.com/Daouthi-Wassim/MedlinkApp.git
cd MedlinkApp
 ```
...
2. Start the app
   ...
   npx expo start
   ```
link web : http://localhost:8081
install expo version android : https://play.google.com/store/apps/details?id=host.exp.exponent&referrer=www
install expo version IOS : https://itunes.apple.com/app/apple-store/id982107779

## 🔒 Sécurité

L'application utilise un système de chiffrement personnalisé pour protéger :
- Les données des patients
- Les communications médecin-patient
- Les dossiers médicaux

## 🛣️ Roadmap

- [ ] Intégration de l'IA pour les diagnostics préliminaires
- [ ] Support des objets connectés de santé
- [ ] Module de prescription électronique
